...
//expander
var sectionArticles = document.getElementById('lpArticles'),
    pagButton = sectionArticles.querySelector('.lpExpander');

function expander(button, section) {
...
}; expander(pagButton, sectionArticles);
